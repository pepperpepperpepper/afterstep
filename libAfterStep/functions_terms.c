...
/* Complex-function management, menu/minipixmap data, and FunctionData
 * formatting, split out of functions.c. The parse/lookup half remains in
 * functions.c; these two TUs communicate through the public functions.h
 * API plus the non-public prototypes in functions_internal.h. */
